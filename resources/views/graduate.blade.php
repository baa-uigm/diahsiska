            ...
            <div class="tab-content shadow-lg p-3 border-top-0 rounded-bottom" style="border: 1px solid black"
                ...
                <div class="tab-pane" id="simple-tabpanel-0" role="tabpanel" aria-labelledby="simple-tab-0">
                    <div class="row justify-content-center align-items-center p-3">
                        <h3 class="text-center mb-4">Data Jumlah Mahasiswa Dengan Pujian</h3>
                        <div class="col-md-6">
                    ...
                    <div class="row justify-content-end align-items-center">
                        ...
                        <div class="col-md-5">
                            <form class="d-flex gap-2">
                                <select class="form-select border-black" id="fakultas">
...
@push('scripts')
    ...
    <script>
        ...
        let ccF = document.getElementById('chartFakultas');
        let ChartFakultas = new Chart(ccF, {
            type: 'bar',
            data: {
                labels: ['Fakultas'],
                datasets: []
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Data Fakultas Dengan Pujian (Cum Laude)',
                        align: 'start',
                        font: {
                            size: 16
                        }
        ...
        dataFakultas.forEach((item, index) => {
            let dataset = {
                label: item.fakultas,
                data: [item.DP],
            ...
            ChartFakultas.data.datasets.push(dataset);
        });
        ...
        let ChartFourYears = new Chart(cCFY, {
            ...
            options: {
                ...
                plugins: {
                    title: {
                        display: true,
                        text: 'Data Lulusan Mahasiswa Lama Studi',
                        align: 'center',
                        font: {
                            size: 16
                        }
